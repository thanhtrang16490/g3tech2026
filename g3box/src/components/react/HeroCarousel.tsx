...
const carouselItems: CarouselItem[] = [
  {
    ...
    subtitle: "Giải pháp toàn diện cho ngôi nhà hiện đại",
    description: "Hệ sinh thái thiết bị thông minh Aqara, Xiaomi, EZVIZ chính hãng. Điều khiển mọi thứ từ smartphone của bạn",
    image: "/images/hero/smart-home-1.jpg",
  ...
  },
  {
    ...
    description: "Cơ hội sở hữu hệ thống nhà thông minh với mức giá ưu đãi chưa từng có. Lắp đặt miễn phí!",
    image: "/images/hero/smart-home-2.jpg",
  ...
  },
  {
    ...
    subtitle: "An ninh toàn diện 24/7",
    description: "Camera EZVIZ với AI nhận diện khuôn mặt, phát hiện chuyển động. Bảo vệ gia đình bạn mọi lúc mọi nơi",
    image: "/images/hero/smart-home-3.jpg",
    buttonText: "Tìm hiểu thêm",
    buttonLink: "/products?category=camera-ai",
